 ...
 */
public class CPhalf_int_pmdFragment extends Fragment {


    public CPhalf_int_pmdFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_cphalf_int_pmd, container, false);

        TextView output_half_inverted_pyramid=view.findViewById(R.id.output_half_inverted_pyramid);
        TextView chalf_inverted_pyramid=view.findViewById(R.id.chalf_inverted_pyramid);
        String data="";
        StringBuffer sbuffer= new StringBuffer();
        InputStream is= this.getResources().openRawResource(R.raw.cinverted_half_pyramid);
        ...
        if(is!=null){
            try{
                ...
                chalf_inverted_pyramid.setText(sbuffer);
                is.close();
            }catch (Exception e){
                e.printStackTrace();}
        }
