 ...
 */
public class CPdec_binFragment extends Fragment {


    public CPdec_binFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_cpdec_bin, container, false);

        TextView coutput_decimal_to_binary=view.findViewById(R.id.output_decimal_to_binary);
        TextView cdecimal_to_binary=view.findViewById(R.id.cdecimal_to_binary);
        String data="";
        StringBuffer sbuffer= new StringBuffer();
        InputStream is= this.getResources().openRawResource(R.raw.cdecimal_to_binary);
        ...
        if(is!=null){
            try{
                ...
                cdecimal_to_binary.setText(sbuffer);
                is.close();
            }catch (Exception e){
                e.printStackTrace();}
        }
