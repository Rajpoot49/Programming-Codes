 ...
 */
public class jhalf_pmdFragment extends Fragment {


    public jhalf_pmdFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_jhalf_pmd, container, false);

        TextView output_half_pyramid=view.findViewById(R.id.output_half_pyramid);
        TextView jhalf_pyramid=view.findViewById(R.id.jhalf_pyramid);
        String data="";
