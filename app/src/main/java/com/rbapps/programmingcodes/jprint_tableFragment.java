 ...
 */
public class jprint_tableFragment extends Fragment {


    public jprint_tableFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_jprint_table, container, false);

        TextView jprint_table=view.findViewById(R.id.jprint_table);
        String data="";
        StringBuffer sbuffer= new StringBuffer();
        InputStream is= this.getResources().openRawResource(R.raw.jprint_table);
