 ...
 */
public class Print_tableFragment extends Fragment {

    private TextView print_table, output_table;

    public Print_tableFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_print_table, container, false);

        print_table= view.findViewById(R.id.print_table);
        output_table= view.findViewById(R.id.output_table);
        String data="";
        StringBuffer sbuffer= new StringBuffer();
        InputStream is= this.getResources().openRawResource(R.raw.print_table);
